...
class RateService {
  async getRate() {
    const response = await client.query(
      `select R.id_rate, R.rate, RT.room_type, RT.id_room_type,  CP.cancellation_policy, R.id_deal, 
  ...
  async editRate(rate, id_room_type, id_cancellation_policy, id_deal, id_rate) {
    await client.query(
